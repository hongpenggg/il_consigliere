...
const DEFAULT_TERRITORIES: Territory[] = [
  ...
  { id: 't6', name: 'Brooklyn',  region: 'usa',   influence: 55, controller: 'Contested',      weeklyIncome: 42000, resistanceLevel: 3, description: 'Working-class neighborhoods with deep union ties. The waterfront is key.',                                             lat: 40.6, lng: -74.0, positionX: 52, positionY: 50 },
